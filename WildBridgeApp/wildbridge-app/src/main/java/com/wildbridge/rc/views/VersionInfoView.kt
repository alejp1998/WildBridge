package com.wildbridge.rc.views
...
import com.wildbridge.rc.data.source.VersionInfo
import com.wildbridge.rc.databinding.LayoutVersionInfoBinding
import com.wildbridge.rc.models.VersionInfoVm
        ...
        binding.itemLatestVersionInfo.setOnClickListener {
            ...
            DialogUtil.showTwoButtonDialog(context, StringUtils.getResStr(R.string.news_dialog_content_tips),
                StringUtils.getResStr(R.string.news_dialog_btn_left), {
                    com.wildbridge.rc.util.Helper.startBrowser(context, StringUtils.getResStr(R.string.release_node_url))
