...
import com.wildbridge.rc.data.FlightControlState
import com.wildbridge.rc.data.MissionUploadStateInfo
        ...
        return if (isGoogleMapsSupported()) {
            ArrayAdapter<String>(
                ...
                ContextUtil.getContext().resources.getStringArray(
                    com.wildbridge.rc.R.array.maps_array_all
                )
            )
        } else {
            ArrayAdapter<String>(
                ...
                R.layout.simple_spinner_dropdown_item,
                ContextUtil.getContext().resources.getStringArray(
                    com.wildbridge.rc.R.array.maps_array
                )
            )
        }
    }
