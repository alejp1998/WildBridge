...
import com.wildbridge.rc.data.DJIRTKBaseStationConnectInfo
import com.wildbridge.rc.data.RtkStationScanAdapter
import com.wildbridge.rc.databinding.FragStationRtkPageBinding
import com.wildbridge.rc.models.RTKStationVM
...
class RTKStationFragment : DJIFragment(), RtkStationScanAdapter.OnItemClickListener {
    ...
    private fun DJIRTKBaseStationConnectInfo.refresh(connectState: RTKStationConnetState?) {
        connectState?.let {
            LogUtils.i(com.wildbridge.rc.pages.RTKStationFragment.TAG, "connectState=$connectState")
