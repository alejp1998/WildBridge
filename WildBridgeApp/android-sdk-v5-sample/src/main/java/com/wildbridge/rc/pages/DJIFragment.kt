...
import com.wildbridge.rc.data.MAIN_FRAGMENT_PAGE_TITLE
import com.wildbridge.rc.models.MSDKInfoVm
import com.wildbridge.rc.util.wheel.PopupNumberPicker
import com.wildbridge.rc.util.wheel.PopupNumberPickerDouble
import com.wildbridge.rc.util.wheel.PopupNumberPickerPosition
...
open class DJIFragment : Fragment() {
    ...
    fun showDialog(title: String, msg: String = "", callback: com.wildbridge.rc.keyvalue.KeyItemActionListener<String>) {
